  ...
  return (
    <div className="flex flex-col gap-8 max-w-2xl mx-auto w-full pt-4 md:pt-12 pb-12">
      ...
      {step === 1 && (
        <div className="animate-in fade-in slide-in-from-right-8">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-extrabold text-brand-900 mb-3">{t('onboarding.whereAreYou')}</h1>
            <p className="text-xl text-gray-600">{t('onboarding.locationDesc')}</p>
          </div>

          <Card className="p-8 md:p-10 shadow-lg">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-3">
                <label className="text-xl font-bold text-gray-800">{t('onboarding.city')}</label>
              ...
              <div className="flex flex-col gap-3">
                <label className="text-xl font-bold text-gray-800">{t('onboarding.localArea')}</label>
                <div className="relative">
      ...
      {step === 2 && (
        <div className="animate-in fade-in slide-in-from-right-8">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-extrabold text-brand-900 mb-3">{t('onboarding.whatDoYouEnjoy')}</h1>
            <p className="text-xl text-gray-600">{t('onboarding.interestsDesc')}</p>
          </div>
          ...
          <Card className="p-8 shadow-lg">
            <div className="flex flex-wrap gap-4">
              {INTERESTS.map(interest => {
                ...
                return (
                  ...
                  >
                    {(t(`onboarding.interest${interest.replace(' ', '')}`) as any) || interest}
            ...
            <div className="flex justify-between mt-10">
              <Button size="lg" variant="outline" className="px-8 h-16 text-xl bg-gray-50" onClick={handleBack}>{t('onboarding.back')}</Button>
      ...
      {step === 3 && (
        <div className="animate-in fade-in slide-in-from-right-8">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-extrabold text-brand-900 mb-3">{t('onboarding.whenAreYouFree')}</h1>
            <p className="text-xl text-gray-600">{t('onboarding.timesDesc')}</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                return (
                  ...
                  >
                    {time.icon}
                    <span className="text-2xl font-bold">{(t(`onboarding.${time.id.toLowerCase()}`) as any) || time.id}</span>
                  </button>
                )
              })}
            </div>
      ...
      {step === 4 && (
        <div className="animate-in fade-in slide-in-from-right-8">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-extrabold text-brand-900 mb-3">{t('onboarding.keepFamilyUpdated')}</h1>
            <p className="text-xl text-gray-600">{t('onboarding.familyDesc')}</p>
          </div>
          ...
          <Card className="p-8 md:p-10 shadow-lg text-center flex flex-col items-center gap-8">
            ...
            <label className="flex items-center gap-4 cursor-pointer bg-brand-50 p-6 rounded-3xl border-2 border-brand-200 w-full md:w-auto hover:bg-brand-100 transition-colors">
              ...
              <span className="text-xl sm:text-2xl font-bold text-brand-900">{t('onboarding.agreeToShare')}</span>
              <input
                type="checkbox"
                className="hidden"
