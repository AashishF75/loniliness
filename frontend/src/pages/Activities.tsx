    ...
    return (
      <div className="flex justify-center items-center py-20">
        <Card className="p-10 text-center bg-brand-50/50 border-brand-100 flex flex-col items-center gap-4">
          ...
          <p className="text-2xl font-bold text-brand-800">Finding local activities for you...</p>
        </Card>
      </div>
    );
  }
          ...
          >
            {isJoined ? (
              <span className="flex items-center">
                <Check className="w-8 h-8 mr-2 text-green-600" /> Joined
              </span>
            ) : (
              'Join'
            )}
  ...
  return (
    <div className="flex flex-col gap-8 md:gap-12 pb-8">
      <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100">
        <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-3">Community Activities</h1>
        <p className="text-xl md:text-2xl text-gray-600 font-medium">Join local events and meet your neighbors.</p>
      </div>
          ...
          <div className="flex flex-col gap-6">
            {todayActivities.length === 0 && (
              <Card className="p-8 text-center bg-gray-50 border-dashed border-2 border-gray-300">
                <p className="text-2xl text-gray-500 font-bold">No activities planned for today.</p>
                <p className="text-lg text-gray-400 mt-2">Check out the upcoming activities below!</p>
              </Card>
            )}
        ...
        <section>
          ...
          <div className="flex flex-col gap-6">
            {upcomingActivities.length === 0 && (
              <Card className="p-8 text-center bg-gray-50 border-dashed border-2 border-gray-300">
                <p className="text-2xl text-gray-500 font-bold">No upcoming activities.</p>
              </Card>
            )}
